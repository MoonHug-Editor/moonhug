...
- [GUI](docs/Gui.md) - mhgui plugin package: Canvas (screen-space overlay), RectTransform anchors/pivot layout, CanvasRenderer + Image (sprite or solid color) through the render collector registry, rect tool on editor/handles
