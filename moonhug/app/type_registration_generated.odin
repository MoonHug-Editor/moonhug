...
register_type_guids :: proc() {
	sync.once_do(&_register_type_guids_once, proc() {
		...
		engine.register_type(engine.DemoMenu, engine.DemoMenu__Guid)
		...
		engine.register_type(engine.Projectile, engine.Projectile__Guid)
		engine.register_type(engine.SceneFile, engine.SceneFile__Guid)
		engine.register_type(engine.SceneRefs, engine.SceneRefs__Guid)
		...
		engine.register_type_key(engine.DemoMenu, engine.TypeKey.DemoMenu)
		...
		engine.register_type_key(engine.Projectile, engine.TypeKey.Projectile)
		engine.register_type_key(engine.SceneFile, engine.TypeKey.SceneFile)
		engine.register_type_key(engine.SceneRefs, engine.TypeKey.SceneRefs)
