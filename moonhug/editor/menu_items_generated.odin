...
_register_menu_items :: proc() {
	...
	menu.add_menu_toggle("View/Playable Graph", &menu.show_playable_graph, 8)
	...
	menu.add_menu_item("View/Theme/Spectrum Dark", "", menu.menu_item_view_theme_spectrum_dark, -14)
	menu.add_menu_item("View/Theme/Spectrum Light", "", menu.menu_item_view_theme_spectrum_light, -13)
