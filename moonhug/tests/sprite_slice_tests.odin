...
test_sprite_quad_slice_and_whole_texture :: proc(t: ^testing.T) {
	rects := [2]engine.Sprite_Rect{
		{name = "a", rect = {0, 0, 100, 100}, pivot = {0.5, 0.5}},
		{name = "b", rect = {100, 0, 100, 50}, pivot = {0, 0}},
	}
	...
	// Empty name: the whole texture, 2 x 1 world units centered on the
	...
	// A name no slice carries renders nothing.
	sr.sprite = "nope"
