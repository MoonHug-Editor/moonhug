...
_particle_system_inspector :: proc(ctx: ^inspector.Component_Ctx) {
	...
	_ps_field(ps, &ps.start_lifetime, typeid_of(engine.MinMax_Curve), "Start Lifetime", "start_lifetime")
	_ps_field(ps, &ps.start_speed, typeid_of(engine.MinMax_Curve), "Start Speed", "start_speed")
	_ps_field(ps, &ps.start_size, typeid_of(engine.MinMax_Curve), "Start Size", "start_size")
	_ps_field(ps, &ps.start_rotation, typeid_of(engine.MinMax_Curve), "Start Rotation", "start_rotation")
