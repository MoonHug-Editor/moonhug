...
register_type_guids :: proc() {
	sync.once_do(&_register_type_guids_once, proc() {
		...
		engine.register_type(audio.AudioListener, engine.AudioListener__Guid)
		engine.register_type(audio.AudioSettings, engine.AudioSettings__Guid, audio.make_pAudioSettings)
		engine.register_type(audio.AudioSource, engine.AudioSource__Guid)
		...
		engine.register_type(app.ButtonsExample, engine.ButtonsExample__Guid)
		...
		engine.register_type(tween.Tween, engine.Tween__Guid)
		engine.register_type(tween.TweenMoveToLocal, engine.TweenMoveToLocal__Guid)
		engine.register_type(tween.TweenPlayer, engine.TweenPlayer__Guid)
		engine.register_type(tween.TweenRotateToLocal, engine.TweenRotateToLocal__Guid)
		engine.register_type(tween.TweenScaleToLocal, engine.TweenScaleToLocal__Guid)
		engine.register_type(plugin_example.TweenSpinnerSpeed, engine.TweenSpinnerSpeed__Guid)
		...
		engine.register_type_key(audio.AudioListener, engine.TypeKey.AudioListener)
		engine.register_type_key(audio.AudioSettings, engine.TypeKey.AudioSettings)
		engine.register_type_key(audio.AudioSource, engine.TypeKey.AudioSource)
		...
		engine.register_type_key(app.ButtonsExample, engine.TypeKey.ButtonsExample)
		...
		engine.register_type_key(tween.Parallel, engine.TypeKey.Parallel)
		...
		engine.register_type_key(tween.Sequence, engine.TypeKey.Sequence)
		...
		engine.register_type_key(tween.Tween, engine.TypeKey.Tween)
		engine.register_type_key(tween.TweenMoveToLocal, engine.TypeKey.TweenMoveToLocal)
		engine.register_type_key(tween.TweenPlayer, engine.TypeKey.TweenPlayer)
		engine.register_type_key(tween.TweenRotateToLocal, engine.TypeKey.TweenRotateToLocal)
		engine.register_type_key(tween.TweenScaleToLocal, engine.TypeKey.TweenScaleToLocal)
		engine.register_type_key(plugin_example.TweenSpinnerSpeed, engine.TypeKey.TweenSpinnerSpeed)
