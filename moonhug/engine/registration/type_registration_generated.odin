...
register_type_guids :: proc() {
	sync.once_do(&_register_type_guids_once, proc() {
		...
		engine.register_type(tween_nodes.TweenRotateToLocal, engine.TweenRotateToLocal__Guid)
		engine.register_type(tween_nodes.TweenScaleToLocal, engine.TweenScaleToLocal__Guid)
		engine.register_type(plugin_example.TweenSpinnerSpeed, engine.TweenSpinnerSpeed__Guid)
		engine.register_type(tween.TweenUnion, engine.TweenUnion__Guid)
		...
		engine.register_type_key(tween_core.Tween, engine.TypeKey.Tween)
		engine.register_type_key(tween_nodes.TweenMoveToLocal, engine.TypeKey.TweenMoveToLocal)
		engine.register_type_key(tween.TweenPlayer, engine.TypeKey.TweenPlayer)
		engine.register_type_key(tween_nodes.TweenRotateToLocal, engine.TypeKey.TweenRotateToLocal)
		engine.register_type_key(tween_nodes.TweenScaleToLocal, engine.TypeKey.TweenScaleToLocal)
		engine.register_type_key(plugin_example.TweenSpinnerSpeed, engine.TypeKey.TweenSpinnerSpeed)
		engine.register_type_key(tween.TweenUnion, engine.TypeKey.TweenUnion)
