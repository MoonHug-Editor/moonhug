...
Track_Desc :: struct {
	...
	// The NAME of the field on the kind's track component that says WHAT the
	// track drives — an animation track's Animation, an audio track's
	// AudioSource. Optional. A driver's inspector (the TimelineAnimator's)
